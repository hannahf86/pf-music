...
const Footer = () => {
  ...
  const layoutStyles = {
    container:
      "w-screen p-6 sm:px-10 bg-accent/20 bottom-0 md:grid grid-cols-4 grid-rows-3 ",
    logo: "w-20",
    ...
    socialContainer: "flex flex-col md:ml-3 ",
    icons: "text-white hover:text-accent mr-4 cursor-pointer",

    contactContainer: "flex flex-col justify-center ",
    contactIcons: "text-button hover:text-accent mr-2 cursor-pointer",
    ...
    navLink: "hover:text-accent font-thin text-xs lg:text-md text-button pt-4",
  ...
  return (
    <div id="footer" className={layoutStyles.container}>
      ...
      <div className="flex items-center mr-8">
        <h3 className="text-button font-bold">PF Music</h3>
      </div>
      {/* NEWSLETTER */}
      ...
      <div id="socialIcons" className={layoutStyles.socialContainer}>
        <div className="flex mt-4">
          ...
          <small className="text-button tracking-wider text-sm">PF Music</small>
        </div>

        <div className="flex mt-4">
          <FaInstagram size={25} className={layoutStyles.contactIcons} />{" "}
          <small className="text-button tracking-wider text-sm">/pfmusic</small>
        </div>
      </div>
      ...
      <div className={layoutStyles.contactContainer}>
        <div className="flex mt-4">
          ...
          <small className="text-button tracking-wider text-sm">
            hello@pfmusic.com
          </small>
        </div>
      </div>
